...
public final class RoomDao {
    ...
    private final Map<Integer, Room> rooms = Map.ofEntries(
            ...
            Map.entry(105, new Room(105, 1500, 2, 0)),
            ...
            Map.entry(204, new Room(10, 2900, 1, 1)),
            Map.entry(205, new Room(11, 2800, 1, 1)),
            // third floor, apartments (king-size + two single beds)
            Map.entry(301, new Room(301, 2850, 2, 1)),
            Map.entry(302, new Room(302, 2800, 2, 1)),
